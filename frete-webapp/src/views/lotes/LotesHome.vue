...
const { data: lotesCarregados, pending: pendingCarregados } = useCollection(query(collection(db, 'lotes'), where("carregamento", "!=", carregamentoZero), orderBy("carregamento", "desc"), orderBy("data_criado", "desc"), limit(10)))
